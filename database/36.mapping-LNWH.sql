...
(1, 'LNWHSilverlink', @scm, 'LNWHSilverlink', 'London North West Hospitals Local Codes', 'London North West Hospitals Sliverlink local code scheme');
...
VALUES ('CM_Org_LNWH', 'CM_Sys_Silverlink', null, null, 'gender', '/LNWH/PIMS/GNDR');    -- Local
...
VALUES
('/LNWH/PIMS/GNDR', 'F', 'KingsPIMS', 'FHIR_AG_female'),
('/LNWH/PIMS/GNDR', 'M', 'KingsPIMS', 'FHIR_AG_male'),
...
-- Context
INSERT INTO map_context_meta (provider, `system`, `schema`, `table`, `column`, node)
VALUES ('CM_Org_LNWH', 'CM_Sys_Silverlink', null, null, 'religion', '/THH/SLVRLNK/RLGN');    -- Local
