...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Org -> Service is relationship, not attribute
       -- Org -> System is relationship, not attribute
       (5410, 12, 'Organisation.ODS', 'ODS Code', ''),
       (5411, 12, 'Organisation.Name', 'Name', ''),
       (5412, 13, 'Organisation.Active', 'Is active', ''),
       -- Org -> Parent organisation is relationship not attribute
       (5413, 7,  'Organisation.Type', 'Organisation type', ''),
       -- Org -> Main location is relationship not attribute
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Location -> Organisation is relationship not attribute
       (5415, 12, 'Location.Name', 'Name', ''),
       (5416, 7,  'Location.Type', 'Location type', ''),
       -- Location -> Address is relationship not attribute
       (5417, 11, 'Location.Start', 'Start date', ''),
       (5418, 11, 'Location.End', 'End date', ''),
       (5419, 13, 'Location.Active', 'Is active', ''),
       -- Location -> Parent location is relationship not attribute
       (5420, 4,  'Location', 'Location', '');
-- Location -> Contact is relationship not attribute
INSERT INTO concept_attribute (concept, attribute, `order`, minimum, maximum)
VALUES
...
-- Practitioner
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES       -- Practitioner -> Organisation is relationship not attribute
       ...
       -- Practitioner -> Gender is relationship not attribute
       (5429, 11, 'Practitioner.BirthDate', 'Date of birth', ''),
       (5430, 13, 'Practitioner.Active', 'Is active', ''),
       -- Practitioner -> Role is relationship
       -- Practitioner -> Speciality is relationship
       (5431, 4,  'Practitioner', 'Practitioner', '');
-- Practitioner -> Contact is relationship
INSERT INTO concept_attribute (concept, attribute, `order`, minimum, maximum)
VALUES
       (5431, 5425, 0, 0, 1),   -- Practitioner -- (0:1) --> Title
       (5431, 5426, 1, 0, 1),   -- Practitioner -- (0:1) --> First name
       (5431, 5427, 2, 0, 1),   -- Practitioner -- (0:1) --> Middle name(s)
       (5431, 5428, 3, 1, 1),   -- Practitioner -- (1:1) --> Last name
       (5431, 5429, 4, 0, 1),   -- Practitioner -- (0:1) --> Date of birth
       (5431, 5430, 5, 1, 1);   -- Practitioner -- (1:1) --> Active flag

-- Practitioner identifier
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES       -- Practitioner Id -> Practitioner is relationship
       (5435, 7,  'Practitioner.Id.Type', 'ID Type' ,''),
       (5436, 12, 'Practitioner.Id.Value', 'ID Value', ''),
       (5437, 4,  'Practitioner.Id', 'Practitioner ID', '');
INSERT INTO concept_attribute (concept, attribute, `order`, minimum, maximum)
VALUES
       (5437, 5435, 0, 1, 1),   -- Practitioner ID -- (1:1) --> ID type
       (5437, 5436, 1, 1, 1);   -- Practitioner ID -- (1:1) --> ID value

-- Patient
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES       -- Patient -> Organisation is relationship
       (5440, 12, 'Patient.NHSNumber', 'NHS number', ''),
       (5441, 7,  'Patient.NHSStatus', 'NHS number verification status', ''),
       (5442, 11, 'Patient.BirthDate', 'Date of birth', ''),
       (5443, 11, 'Patient.DeathDate', 'Date of death', ''),
       -- Patient -> Gender is relationship
       -- Patient -> Usual practitioner is relationship
       (5444, 12, 'Patient.Title', 'Title', ''),
       (5445, 12, 'Patient.FirstName', 'First name', ''),
       (5446, 12, 'Patient.MiddleNames', 'Middle name(s)', ''),
       (5447, 12, 'Patient.LastName', 'Last name', ''),
       (5448, 12, 'Patient.PreviousLastName', 'Previous last name', ''),
       -- Patient -> Home address is relationship
       (5449, 13, 'Patient.IsSpineSensitive', 'Is spine sensitive', ''),
       (5450, 11, 'Patient.DateAdded', 'Date added', ''),
       (5451, 11, 'Patient.DateEntered', 'Date entered', ''),
       -- Patient -> Entered by is relationship
       (5452, 4,  'Patient', 'Patient', '');
INSERT INTO concept_attribute (concept, attribute, `order`, minimum, maximum)
VALUES
       (5452, 5440, 0,  1, 1),   -- Patient -- (1:1) --> NHS Number
       (5452, 5441, 1,  1, 1),   -- Patient -- (1:1) --> NHS Number status
       (5452, 5442, 2,  0, 1),   -- Patient -- (0:1) --> Birth date
       (5452, 5443, 3,  0, 1),   -- Patient -- (0:1) --> Death date
       (5452, 5444, 4,  0, 1),   -- Patient -- (0:1) --> Title
       (5452, 5445, 5,  0, 1),   -- Patient -- (0:1) --> First name
       (5452, 5446, 6,  0, 1),   -- Patient -- (0:1) --> Middle name(s)
       (5452, 5447, 7,  1, 1),   -- Patient -- (1:1) --> Last name
       (5452, 5448, 8,  0, 0),   -- Patient -- (0:*) --> Previous last name(s)
       (5452, 5449, 9,  1, 1),   -- Patient -- (1:1) --> Is spine sensitive
       (5452, 5450, 10, 1, 1),   -- Patient -- (1:1) --> Date added
       (5452, 5451, 11, 1, 1);   -- Patient -- (1:1) --> Date entered

-- Patient address
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES       -- Patient -> Patient address is relationship
       (5460, 7,  'Patient.Address.Type', 'Type', ''),
       -- Patient address -> address is relationship
...
-- Patient contact
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES       -- Patient -> Patient contact is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
        -- Patient -> Patient identifier is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Organisation -> Prompt is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Appointment schedule -> Organisation is relationship
       -- Appointment schedule -> Location is relationship
       ...
       -- Appointment schedule -> Practitioner is relationship (with "Main" attribute)
INSERT INTO concept_attribute (concept, attribute, `order`, minimum, maximum)
VALUES
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Appointment slot -> Appointment schedule is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Booking -> Slot is relationship
       (5515, 11, 'Booking.Time', 'Booking tme', ''),
       -- Booking -> Patient is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Attendance -> Slot is relationship
       -- Attendance -> Patient is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Attendance event -> Slot is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Registration status -> patient is relationship
       -- Registration status -> organisation is relationship
       ...
       -- Registration status -> Practitioner is relationship
       ...
       -- Registration status -> Entered by is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Episode status -> Patient is relationship
       -- Episode status -> Organisation is relationship
       -- Episode status -> Episode is relationship
...
VALUES
       ...
       -- Consultation -> Location is relationship
       -- Consultation -> Appointment slot is relationship
       -- Consultation -> Referral request is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Hosp. encounter -> Patient is relationship
       -- Hosp. encounter -> Care episode is relationship
       ...
       -- Hosp. encounter -> Owning organisation is relationship
       ...
       -- Hosp. encounter -> Location is relationship
       -- Hosp. encounter -> referral request is relationship
       (5579, 13, 'Encounter.IsConsent', 'Consent flag', ''),
       (5580, 4,  'Encounter', 'Hospital encounter', '');
        -- Hosp. encounter -> Practitioner is relationship (1:*)
INSERT INTO concept_attribute (concept, attribute, `order`, minimum, maximum)
VALUES
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- A&E -> Patient is relationship
       -- A&E -> Encounter is relationship
       -- A&E -> Care episode is relationship
       ...
       -- A&E -> Effective practitioner is relationship
       -- A&E -> Triage practitioner is relationship
       (5589, 11, 'A&E.EndDate', 'End date', ''),
       (5590, 11, 'A&E.InsertDate', 'Insert date', ''),
       (5591, 11, 'A&E.EnteredDate', 'Entered date', ''),
       -- A&E -> Received practitioner is relationship
       -- A&E -> Entered practitioner is relationship
       -- A&E -> Owning organisation is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Outpatient -> Patient is relationship
       -- Outpatient -> Encounter is relationship
       -- Outpatient -> Care episode is relationship
       (5600, 11, 'Outpatient.EffectiveDate', 'EffectiveDate', ''),
       (5601, 8,  'Outpatient.EffectiveDatePrecision', 'Effective date precision', ''),
       -- Outpatient -> Effective practitioner is relationship
       (5602, 11, 'Outpatient.EndDate', 'End date', ''),
       (5603, 11, 'Outpatient.InsertDate', 'Insert date', ''),
       (5604, 11, 'Outpatient.EnteredDate', 'Entered date', ''),
       -- Outpatient -> Entered practitioner is relationship
       -- Outpatient -> Usual practitioner is relationship
       -- Outpatient -> Owning organisation is relationship
       ...
       -- Outpatient -> Location is relationship
       -- Outpatient -> Appointment slot is relationship
       -- Outpatient -> Referral request is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Admission -> Patient is relationship
       -- Admission -> Encounter is relationship
       -- Admission -> Episode is relationship
       (5615, 11, 'Admission.EffectiveDate', 'Effective date', ''),
       (5616, 8,  'Admission.EffectiveDatePrecision', 'Effective date precision', ''),
       -- Admission -> Effective practitioner is relationship
       (5617, 11, 'Admission.EndDate', 'End date', ''),
       (5618, 11, 'Admission.InsertDate', 'Insert date', ''),
       (5619, 11, 'Admission.EnteredDate', 'Entered date', ''),
       -- Admission -> Entered practitioner is relationship
       -- Admission -> Owning organisation is relationship
       ...
       -- Admission -> Location is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Ward Transfer -> Patient is relationship
       -- Ward Transfer -> Encounter is relationship
       -- Ward Transfer -> Care episode is relationship
       (5630, 11, 'WardTransfer.EffectiveDate', 'Effective date', ''),
       (5631, 8,  'WardTransfer.EffectiveDatePrecision', 'Effective date precision', ''),
       -- Ward Transfer -> Effective practitioner is relationship
       ...
       -- Ward Transfer -> Entered practitioner is relationship
       -- Ward Transfer -> Owning organisation is relationship
       ...
       -- Ward Transfer -> Location is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Discharge -> Patient is relationship
       -- Discharge -> Encounter is relationship
       -- Discharge -> Episode is relationship
       (5645, 11, 'Discharge.EffectiveDate', 'Effective date', ''),
       (5646, 8,  'Discharge.EffectiveDatePrecision', 'Effective date precision', ''),
       -- Discharge -> Effective practitioner is relationship
       (5647, 11, 'Discharge.EndDate', 'End date', ''),
       (5648, 11, 'Discharge.InsertDate', 'Insert date', ''),
       (5649, 11, 'Discharge.EnteredDate', 'Entered date', ''),
       -- Discharge -> Entered practitioner is relationship
       -- Discharge -> Owning organisation is relationship
       ...
       -- Discharge -> Location is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Observation -> Patient is relationship
       ...
       -- Observation -> Effective practitioner is relationship
       (5663, 11, 'Observation.InsertDate', 'Insert date', ''),
       (5664, 11, 'Observation.EnteredDate', 'Entered date', ''),
       -- Observation -> Entered practitioner is relationship
       -- Observation -> Care activity is relationship ??? TODO: Or is it!?
       (5665, 7,  'Observation.CareActivityHeading', 'Care activity heading', ''),
       -- Observation -> Owning organisation is relationship
       ...
       -- Observation -> Entry prompt is relationship
...
VALUES
       ...
       -- Flag -> Effective practitioner is relationship
       (5678, 11, 'Flag.EndDate', 'End date', ''),
       (5679, 11, 'Flag.InsertDate', 'Insert date', ''),
       (5680, 11, 'Flag.EnteredDate', 'Entered date', ''),
       -- Flag -> Entered practitioner
       -- Flag -> Care activity is relationship ??? TODO: Or is it!?
       (5681, 7,  'Flag.CareActivityHeading', 'Care activity heading', ''),
       -- Flag -> Owning organisation is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Problem -> Patient is relationship
       -- Problem -> Observation is relationship
       ...
       -- Problem -> Last review practitioner is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Procedure request -> Patient is relationship
       ...
       -- Procedure request -> Effective practitioner is relationship
       (5703, 11, 'ProcedureRequest.InsertDate', 'Insert date', ''),
       (5704, 11, 'ProcedureRequest.EnteredDate', 'Entered date', ''),
       -- Procedure request -> Entered practitioner is relationship
       -- Procedure request -> Care activity is relationship ??? TODO: Or is it!?
       (5705, 7,  'ProcedureRequest.CareActivityHeading', 'Care activity heading', ''),
       -- Procedure request -> Owning organisation is relationship
       ...
       -- Procedure request -> Recipient organisation is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Procedure -> Patient is relationship
       ...
       -- Procedure -> Effective practitioner is relationship
       (5718, 11, 'Procedure.EndDate', 'End date', ''),
       (5719, 11, 'Procedure.InsertDate', 'Insert date', ''),
       (5720, 11, 'Procedure.EnteredDate', 'Entered date', ''),
       -- Procedure -> Entered practitioner is relationship
       -- Procedure -> Usual practitioner is relationship
       -- Procedure -> Care activity is relationship ??? TODO: Or is it!?
       (5721, 7,  'Procedure.CareActivityHeading', 'Care activity heading', ''),
       -- Procedure -> Owning organisation is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Device -> Organisation is relationship
...
-- Procedure -> Procedure device is relationship
...
VALUES
       ...
       -- Observation value -> Reference range is relationship
       (5746, 4,  'Observation.Value', 'Observation value', '');
INSERT INTO concept_attribute (concept, attribute, `order`, minimum, maximum)
VALUES
       (5746, 5740, 0, 1, 1),   -- Observation value (1:1) --> Operator
       (5746, 5741, 1, 0, 1),   -- Observation value (0:1) --> Numeric
       (5746, 5742, 2, 0, 1),   -- Observation value (0:1) --> Units    -- TODO: Should this att be on Numeric instead of Obs?
...
-- Observation -> Observation value is relationship?

-- Immunisation
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Immunisation -> Patient is relationship
       ...
       -- Immunisation -> Effective practitioner is relationship
       (5753, 11, 'Immunisation.InsertDate', 'Insert date', ''),
       (5753, 11, 'Immunisation.EnteredDate', 'Entered date', ''),
       -- Immunisation -> Entered practitioner is relationship
       -- Immunisation -> Care activity id is relationship TODO: Or is it!?
       (5754, 7,  'Immunisation.CareActivityHeading', 'Care activity heading', ''),
       -- Immunisation -> Owning organisation is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Allergy -> Patient is relationship
       ...
       -- Allergy -> Effective practitioner is relationship
       (5773, 11, 'Allergy.InsertDate', 'Insert date', ''),
       (5774, 11, 'Allergy.EnteredDate', 'Entered date', ''),
       -- Allergy -> Entered practitioner is relationship
       -- Allergy -> Care activity is relationship TODO: Or is it!?
       (5775, 7,  'Allergy.CareActivityHeading', 'Care activity heading', ''),
       -- Allergy -> Owning organisation is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Referral -> Patient is relationship
       ...
       -- Referral -> Effective practitioner is relationship
       (5788, 11, 'Referral.InsertDate', 'Insert date', ''),
       (5789, 11, 'Referral.EnteredDate', 'Entered date', ''),
       -- Referral -> Entered practitioner is relationship
       -- Referral -> Care activity is relationship TODO: Or is it!?
       (5790, 7,  'Referral.CareActivityHeading', 'Care activity heading', ''),
       -- Referral -> Owning organisation is relationship
       ...
       -- Referral -> Sender organisation is relationship
       -- Referral -> Recipient organisation is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Medication amount -> Patient is reference
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Medication statement -> Patient is relationship
       -- Medication statement -> Drug is relationship
       ...
       -- Medication statement -> Effective practitioner is relationship
       (5813, 11, 'MedicationStatement.InsertDate', 'Insert date', ''),
       (5814, 11, 'MedicationStatement.EnteredDate', 'Entered date', ''),
       -- Medication statement -> Entered practitioner is relationship
       -- Medication statement -> Care activity is relationship TODO: Or is it!?
       (5815, 7,  'MedicationStatement.CareActivityHeading', 'Care activity heading', ''),
       -- Medication statement -> Owning organisation is relationship
       ...
       -- Medication statement -> Medication amount is relationship TODO: ???
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Medication order -> Patient is relationship
       -- Medication order -> Drug is relationship TODO:??
       ...
       -- Medication order -> Effective practitioner is relationship
       (5837, 11, 'MedicationOrder.InsertDate', 'Insert date', ''),
       (5838, 11, 'MedicationOrder.EnteredDate', 'Entered date', ''),
       -- Medication order -> Entered practitioner is relationship
       -- Medication order -> Care activity is relationship TODO: Or is it!?
       (5839, 7,  'MedicationOrder.CareActivityHeading', 'Care activity heading', ''),
       -- Medication order -> Owning organisation is relationship
       ...
       -- Medication order -> Medication statement is relationship
       -- Medication order -> Medication amount is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Related person -> Patient is relationship
       ...
       -- Related person --> Address is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Related person contact -> Patient is relationship
       -- Related person contact -> Related person is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Care plan -> Patient is relationship
       ...
       -- Care plan -> Effective practitioner is relationship
       (5873, 11, 'CarePlan.InsertDate', 'Insert date', ''),
       (5874, 11, 'CarePlan.EnteredDate', 'Entered date', ''),
       -- Care plan -> Entered practitioner is relationship
      -- Care plan -> Care activity is relationship TODO: Or is it!?
       (5875, 7,  'CarePlan.CareActivityHeading', 'Care activity heading', ''),
       -- Care plan -> Owning organisation is relationship
       ...
       -- Care plan -> Follow up event is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Care plan activity -> Care plan is relationship
       -- Care plan activity -> Patient is relationship
       ...
       -- Care plan activity -> Effective practitioner is relationship
       (5888, 11, 'CarePlan.Activity.InsertDate', 'Insert date', ''),
       (5889, 11, 'CarePlan.Activity.EnteredDate', 'Entered date', ''),
       -- Care plan activity -> Entered practitioner is relationship
       -- Care plan activity -> Care activity is relationship TODO: Or is it!?
       (5890, 7,  'CarePlan.Activity.CareActivityHeading', 'Care activity heading', ''),
       -- Care plan activity -> Owning organisation is relationship
...
INSERT INTO concept (id, superclass, context, full_name, description)
VALUES
       -- Care plan activity target -> Care plan activity is relationship
       -- Care plan activity target -> Patient is relationship
       ...
       -- Care plan activity target -> Effective practitioner is relationship
       ...
       -- Care plan activity target -> Entered practitioner is relationship
       -- Care plan activity target -> Care activity is relationship TODO: Or is it!?
       (5906, 7,  'CarePlan.Activity.Target.CareActivityHeading', 'Care activity heading', ''),
       -- Care plan activity target -> Owning organisation is relationship
