...
public class ConceptLogic {
    ...
    public ConceptSummaryList getMRU(Boolean activeOnly) throws Exception {
        return dal.getMRU(activeOnly);
    }

    public ConceptSummaryList search(String searchTerm, Boolean activeOnly) throws Exception {
        return dal.search(searchTerm, activeOnly);
    }
